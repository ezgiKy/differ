...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(InvalidBase64InputException.class)
	public final ResponseEntity<Object> handleInvalidBase64InputExceptions(InvalidBase64InputException ex,
			WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
		return new ResponseEntity<Object>(exceptionResponse, HttpStatus.BAD_REQUEST);
	...
	@ExceptionHandler(InvalidDiffDataException.class)
	public final ResponseEntity<Object> handleInvalidDiffDataExceptions(InvalidDiffDataException ex,
			WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
		return new ResponseEntity<Object>(exceptionResponse, HttpStatus.BAD_REQUEST);
